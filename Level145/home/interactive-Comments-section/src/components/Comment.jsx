...
function Comment(props) {
  ...
  const CommentBlock = (
    <div className="comment my-3 w-full ml-auto rounded-md  ring-1 ring-gray-100 bg-white text-gray-500 p-4 grid grid-cols-2 md:grid-cols-8 md:justify-items-start md:content-center">
      ...
      <div className="btn-score w-22.5 mx-2 rounded-md flex-auto flex flex-row items-center justify-around bg-gray-100 col-span-1 md:flex-col md:order-1 md:mx-auto md:row-span-2 md:w-11.25 md:h-25 md:mb-auto">
        <button className="w-full h-full btn-upvote md:w-auto" onClick={upVote}>
          <IconPlus className="mx-auto" />
        </button>
        <span className="score w-7.5 inline-block blue-accent-text text-center font-bold">
          {comment.score}
        </span>
        <button
